...
export const gridItems = [
  ...
  },
  {
    id: 3,
    title: "",
    description: "Mes principales technos",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
...
export const cicdtutorialsItems = [
  ...
  {
    id: 5,
    title: "Mettre en place un CI/CD sur AWS avec CodePipeline et CodeBuild",
    desc: "Crée un pipeline CI/CD avec les outils natifs d’AWS pour builder, tester et déployer automatiquement ton application.",
    img: "/aws.png",
    date: "2026-01-09",
    category: categories[3].name,
    technologies: [""],
