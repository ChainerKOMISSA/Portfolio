                            ...
                            <div className="w-full space-y-16">
                                <section id="intro">
                                    ...
                                    <p className="text-gray-300">
                                        Vercel est une plateforme moderne d&apos;hébergement spécialisée dans les applications front-end, idéale pour les projets React, Next.js, Vue, ou autres frameworks modernes. <br />
                                        Elle offre un déploiement continu, une configuration minimale et une intégration directe avec GitHub. <br /><br />
                                        Dans ce tutoriel, nous allons voir comment héberger une application front-end sur Vercel en quelques étapes simples.
                                    </p>
                                </section>
