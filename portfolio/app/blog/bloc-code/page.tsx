        ...
        <main className="min-h-screen p-10 bg-black-100 flex flex-col overflow-hidden mx-auto sm:px-10 px-5">
            ...
            <div className="relative mx-auto my-10 flex max-w-7xl flex-col">
                <header className="w-full px-4 md:px-8 py-6">
                    <h1 className="text-5xl font-bold text-slate-500 text-center">Ajouter des blocs de code à son site web</h1>
                </header>
                                ...
                                <section id="setup">
                                    ...
                                    <ul className="space-y-2 my-2">
                                        <li className="flex items-start space-x-2">
                                            ...
                                            <span><code className="text-blue-400">react-copy-to-clipboard</code> pour la copie du code,</span>
                                        </li>
                                        <li className="flex items-start space-x-2">
                                            <svg className="w-4 h-4 text-green-600 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                                            </svg>
                                            <span><code className="text-blue-400">react-syntax-highlighter</code> pour la coloration syntaxique et </span>
                                        </li>
                                        <li className="flex items-start space-x-2">
                                            <svg className="w-4 h-4 text-green-600 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                                            </svg>
                                            <span><code className="text-blue-400">react-icons</code> pour les icônes.</span>
                                        </li>
                                    </ul>
